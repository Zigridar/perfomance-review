...
const perfomanveReviewRouter = (jwtSecret: string) => {
  ...
  router.get(
    ...
    async (req: express.Request<never, never, never, QueryPerfomanceReview>, res: express.Response) => {
      try {
  ...
  router.post(
    ...
    async (req: express.Request<ParamsDictionary, never, IPerfomanceReviewWithId>, res: express.Response) => {
      try {
  ...
  router.delete(
    ...
    async (req: express.Request<ParamsDictionary, any, IPerfomanceReviewWithId>, res: express.Response) => {
      try {
        ...
        const pr: Nullable<DocumentPerfomanceReview> = await PerfomanceReview.findOne({ _id: iD });
